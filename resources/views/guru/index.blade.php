                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">
                                    <img class="mx-auto h-full dark:hidden" style="width: 150px" src="{{ asset('storage/' . $siswa->bukti) }}" alt="{{ $siswa->bukti }}">
                                </td>
                                <td class="px-4 py-3">
                                    <span class="badge @if ($siswa->status == 'sedang dalam tinjuan')bg-red-200 rounded-md px-1 py-1 text-red    @elseif($siswa->status == 'done')badge-success @endif">
                                        {{$siswa->status}}
                                    </span>
                                </td>
                                <td class="px-4 py-3">
                                    <a href="{{ route('guru.edit', $siswa->id) }}" class="text-white bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 shadow-lg shadow-lime-500/50 dark:shadow-lg dark:shadow-lime-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Edit</a>
                                </td>
                            </tr>
